...
variable "username" {
  description = "This is RDS username"
}
...
variable "allocated_storage" {
  description = "Holds the amount of allocated storage to DB"
}

variable "skip_final_snapshot" {
  description = "It will creates a snapshot when db is deleted if set to true"
}
